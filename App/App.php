<?php
	...
	class App{
		...
		public $title = 'Africa Management Sport Agency';
		public $desc_page = '...';
		...
		public static function load(){
			...
			AfricaSportManagementAgency\Autoloader::register();
		...
		public function getTable($name){
			$class_name = '\\AfricaSportManagementAgency\\Table\\'.ucfirst($name).'Table';
